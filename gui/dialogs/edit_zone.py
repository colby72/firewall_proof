...
class DialogEditZone(QDialog):
    def __init__(self, main_window, company, zone):
        super().__init__()
        ...
        self.purdue_level.setCurrentText(str(self.zone.level))
        ...
        self.html_color = QLabel(self.zone.color)
    ...
    def when_ok(self):
        ...
        self.zone.set_name(zone_name)
        self.zone.set_level(purdue_level)
        self.zone.set_description(zone_desc)
        self.zone.set_color(color)
        self.close()
