...
class DialogAddZone(QDialog):
    def __init__(self, main_window, company):
        ...
        layout.addWidget(self.zone_desc, 2, 1)
    ...
    def when_ok(self):
        ...
        new_zone = Zone(zone_name, purdue_level, zone_desc)
