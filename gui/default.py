...
class DefaultGUI(QWidget):
    def __init__(self, main_window):
        ...
        #self.setStyleSheet(get_stylesheet("default.qss"))
        ...
        self.new_button.setFixedSize(350, 80)
        self.new_button.setIconSize(QSize(35, 35))
        self.new_button.setObjectName("default_widget_btn")
        layout.addWidget(self.new_button, 2, 1, 1, 1)

        self.open_button = QPushButton("  Open project")
        self.open_button.setIcon(QIcon("img/file_open_icon.png"))
        self.open_button.clicked.connect(self.open_project)
        self.open_button.setFixedSize(350, 80)
        self.open_button.setIconSize(QSize(35, 35))
        self.open_button.setObjectName("default_widget_btn")
        layout.addWidget(self.open_button, 3, 1, 1, 1)
